...
function loadList() {
    logger("execute");
    changeInfo('<img src="images/wait.gif"/> <label>Retrieve data...</label>');
...
function loadRaw(hashData, idComponentToRender, idButtonShow) {
    ...
    if (idCol.style.display == "none") {
        ...
        idButton.style.backgroundImage = "url(./images/if_arrow_up2_1814087.png)";
    } else {
        idCol.style.display = "none";
        idButton.innerHTML = "show raw";
        idButton.style.backgroundImage = "url(./images/if_arrow_down_1814087.png)";
        clearRaw(idComponentToRender);
    }
    idCol.innerHTML = '<img src="./images/wait.gif"/> <label>Retrieve data...</label>';
